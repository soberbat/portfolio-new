        ...
        <Projectİnfos variants={ContProps} initial="initial" animate="animate">
          <AboutContainer {...ItemProps}>
            ...
            <AboutText>
              ...
              fetching skills and manipulating that data according to the
              desired result. There's an SVG map which you can explore selected
              countries' particular attributes like population, neighbouring
              countries, currency and so on. Got the help of
              <span> SVGR</span> and
          ...
          <Obstacles {...ItemProps}>
            ...
            <span>
              ...
              information about endangered animals but even getting APİ key was
              a problem. I've sent couple of mails but got 0 respond. So I gave
              up and choose something relatively simple.
            </span>
            ...
            <span>
              ...
              give another shot using it with React. Of course it was not the
              same as using it with HTML but still with the state of mind I have
              now every letter matters. Template literals, questions marks in
