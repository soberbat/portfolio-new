      ...
      <Container>
        ...
        <Projectİnfos variants={ContProps} initial="initial" animate="animate">
          <AboutContainer {...ItemProps}>
            ...
            <AboutText>
              This app let's you create a resume and download it as a PDF. You
              can easily add your skills, education and internships to your
              resume. Also there are extras. There's also a logo that designed
              by me.
            </AboutText>
          </AboutContainer>
          ...
          <Obstacles {...ItemProps}>
            ...
            <span>
              ...
              management tool. So I've got the help of Redux since the app was
              too complex to use regular state in react. Because with regular
              state:
              <ul>
                <li>
            ...
            <span>
              ...
              look clean. So I looked for solutions and came across with CSS in
              JS library Styled Components. It was super easy to get used to it
              and use its magical powers like nesting, dynamic styling, theming
              etc.
            </span>
          </Obstacles>
